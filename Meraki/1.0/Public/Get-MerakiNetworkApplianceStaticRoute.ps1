function Get-MerakiNetworkApplianceStaticRoute {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/appliance/staticRoutes/$StaticRouteId" -Header $header -ErrorAction Stop
        return $response
    }
    catch {
