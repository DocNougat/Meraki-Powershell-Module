function Get-MerakiOrganizationWirelessDevicesPacketLossByClient {
    <#
    .SYNOPSIS
    Retrieves packet loss data by client for wireless devices in an organization.

    .DESCRIPTION
    This function allows you to retrieve packet loss data by client for wireless devices in a given organization by providing the authentication token, organization ID, and optional query parameters.
    ...
    .EXAMPLE
    Get-MerakiOrganizationWirelessDevicesPacketLossByClient -AuthToken "your-api-token" -OrganizationId "123456" -NetworkIds @("N_1234", "N_5678") -Timespan 604800

    This example retrieves packet loss data by client for wireless devices in the organization with ID "123456" for the past 7 days, filtered by the specified network IDs.
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/organizations/$OrganizationId/wireless/devices/packetLoss/byClient?$queryString"
