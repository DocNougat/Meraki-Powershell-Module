function Get-MerakiOrganizationDevicesStatuses {
    <#
    .SYNOPSIS
    Retrieves the device statuses for an organization in the Meraki Dashboard.

    .DESCRIPTION
    The Get-MerakiOrganizationDevicesStatuses function retrieves the device statuses for an organization in the Meraki Dashboard using the Meraki Dashboard API. This function requires an API key for authentication.
    ...
    .EXAMPLE
    PS C:\> Get-MerakiOrganizationDevicesStatuses -AuthToken "1234567890abcdef" -OrgId "1234567890" -serials "Q2FN-3V7D-JN25"

    This example retrieves the device statuses for an organization with ID "1234567890", filtering by the device with serial number "Q2FN-3V7D-JN25".
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        Try { 
            ...
            $URI = "https://api.meraki.com/api/v1/organizations/$OrganizationID/devices/statuses?$queryString"
