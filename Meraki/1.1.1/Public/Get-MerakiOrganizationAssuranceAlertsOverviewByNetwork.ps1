function Get-MerakiOrganizationAssuranceAlertsOverviewByNetwork {
    <#
    .SYNOPSIS
    Retrieves an overview of assurance alerts by network for a specified organization.

    .DESCRIPTION
    This function allows you to retrieve an overview of assurance alerts by network for a specified organization by providing the authentication token, organization ID, and optional query parameters.
    ...
    .EXAMPLE
    Get-MerakiOrganizationAssuranceAlertsOverviewByNetwork -AuthToken "your-api-token" -OrganizationId "123456" -Severity "critical" -Active $true

    This example retrieves an overview of critical active assurance alerts by network for the organization with ID "123456".
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/organizations/$OrganizationId/assurance/alerts/overview/byNetwork?$queryString"
