function Invoke-MerakiNetworkFirmwareUpgradesRollbackStagedEvents {
    ...
    $config = [PSCustomObject]@{
        reasons = @("Rollback due to issues with new firmware")
        stages = @(
            [PSCustomObject]@{
    ...
    Invoke-MerakiNetworkFirmwareUpgradesRollbackStagedEvents -AuthToken "your-api-token" -NetworkId "L_123456789012345678" -FirmwareRollbackConfig $configJson
