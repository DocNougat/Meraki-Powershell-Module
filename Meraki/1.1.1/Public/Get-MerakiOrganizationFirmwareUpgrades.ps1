function Get-MerakiOrganizationFirmwareUpgrades {
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/organizations/$OrganizationID/firmware/upgrades" -headers $header -UserAgent "MerakiPowerShellModule/1.1.1 DocNougat"
