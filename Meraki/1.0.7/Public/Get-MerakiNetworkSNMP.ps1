function Get-MerakiNetworkSNMP {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/snmp" -Header $header -UserAgent "MerakiPowerShellModule/1.0.2 DocNougat"
