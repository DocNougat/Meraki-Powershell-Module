function Get-MerakiNetworkSensorMqttBrokers {
<#
.SYNOPSIS
...
Get-MerakiNetworkSensorMqttBrokers -AuthToken $apiKey -NetworkId $networkId
...
#>
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/sensor/mqttBrokers" -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat"
        return $response
    }
    catch {
        Write-Debug $_
