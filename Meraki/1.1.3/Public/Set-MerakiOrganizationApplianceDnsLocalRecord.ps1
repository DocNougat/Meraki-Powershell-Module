function Set-MerakiOrganizationApplianceDnsLocalRecord {
<#
.SYNOPSIS
Updates a Meraki Appliance DNS record for an organization.

.DESCRIPTION
Calls the Meraki Dashboard API to update a DNS record associated with the specified organization.
...
Set-MerakiOrganizationApplianceDnsLocalRecord -AuthToken 'xxxxxxxxxxxxxxxxxxxx' -recordId 'xxxxxxxxxxxx' -recordJson $config
.LINK
