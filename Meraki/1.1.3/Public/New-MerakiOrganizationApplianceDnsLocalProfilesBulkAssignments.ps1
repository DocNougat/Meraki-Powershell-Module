function New-MerakiOrganizationApplianceDnsLocalProfilesBulkAssignments {
<#
.SYNOPSIS
Creates a new local DNS profile for Meraki MX appliances in the specified organization in bulk.
...
New-MerakiOrganizationApplianceDnsLocalProfilesBulkAssignments -AuthToken $apiKey -BulkProfileConfig $DNSProfileConfig
...
#>
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $body = $BulkDNSProfileConfig

            $url = "https://api.meraki.com/api/v1/organizations/$OrganizationId/appliance/dns/local/profiles/assignments/bulkCreate"
