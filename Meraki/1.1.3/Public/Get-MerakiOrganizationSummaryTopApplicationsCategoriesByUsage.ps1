function Get-MerakiOrganizationSummaryTopApplicationsCategoriesByUsage {
    <#
    .SYNOPSIS
    Retrieves the top application categories by usage for an organization.

    .DESCRIPTION
    This function allows you to retrieve the top application categories by usage for an organization by providing the authentication token, organization ID, and optional query parameters for filtering and pagination.
    ...
    .EXAMPLE
    Get-MerakiOrganizationSummaryTopApplicationsCategoriesByUsage -AuthToken "your-api-token" -OrganizationId "123456" -Quantity 20

    This example retrieves the top 20 application categories by usage for the organization with ID "123456".
