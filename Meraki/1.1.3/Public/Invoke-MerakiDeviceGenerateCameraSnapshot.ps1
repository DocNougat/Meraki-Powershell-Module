function Invoke-MerakiDeviceGenerateCameraSnapshot {
    ...
    #>
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/devices/$DeviceSerial/camera/generateSnapshot"
    
            $response = Invoke-RestMethod -Method Post -Uri $url -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat" -Body $SnapshotConfig
            return $response
        }
        catch {
        Write-Debug $_
