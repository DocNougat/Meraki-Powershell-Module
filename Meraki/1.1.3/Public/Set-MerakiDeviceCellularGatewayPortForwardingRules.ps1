function Set-MerakiDeviceCellularGatewayPortForwardingRules {
    ...
    $PortForwardingRules = $PortForwardingRules | ConvertTo-Json -Compress -Depth 4
    ...
    #>
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/devices/$DeviceSerial/cellularGateway/portForwardingRules"
