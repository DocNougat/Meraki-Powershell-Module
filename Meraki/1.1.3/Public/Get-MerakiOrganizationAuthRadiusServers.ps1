function Get-MerakiOrganizationAuthRadiusServers {
    <#
    .SYNOPSIS
    ...
    Get-MerakiOrganizationAuthRadiusServers -AuthToken 'ABCDEF123456' -OrganizationID '123456'

    .EXAMPLE
    # Let the helper determine the organization ID (only works when a single org is found)
    Get-MerakiOrganizationAuthRadiusServers -AuthToken 'ABCDEF123456'
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/organizations/$OrganizationID/auth/radius/servers" -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat"
            return $response
        }
        catch {
        Write-Debug $_
