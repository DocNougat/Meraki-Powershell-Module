function Set-MerakiDeviceCellularGatewayLAN {
    ...
    $LANConfig = $LANConfig | ConvertTo-Json -Compress -Depth 4
    ...
    #>
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/devices/$DeviceSerial/cellularGateway/lan"
    
            $response = Invoke-RestMethod -Method Put -Uri $url -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat" -Body $LANConfig
            return $response
        }
        catch {
        Write-Debug $_
