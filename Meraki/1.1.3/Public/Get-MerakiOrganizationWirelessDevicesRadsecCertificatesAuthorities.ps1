function Get-MerakiOrganizationWirelessDevicesRadsecCertificatesAuthorities {
    <#
    .SYNOPSIS
    Retrieves RadSec certificate authority records for wireless devices in a Meraki organization.
    ...
    Get-MerakiOrganizationWirelessDevicesRadsecCertificatesAuthorities -AuthToken 'abcd1234'
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try { 
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/wireless/devices/radsec/certificates/authorities?$queryString"
