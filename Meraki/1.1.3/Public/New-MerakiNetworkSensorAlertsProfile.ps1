function New-MerakiNetworkSensorAlertsProfile {
    ...
    $AlertsProfileConfig = $AlertsProfileConfig | ConvertTo-Json -Compress -Depth 4
    ...
    #>
        ...
        try {
            ...
            $response = Invoke-RestMethod -Method Post -Uri $url -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat" -Body $AlertsProfileConfig
            return $response
        }
        catch {
            Write-Debug $_
