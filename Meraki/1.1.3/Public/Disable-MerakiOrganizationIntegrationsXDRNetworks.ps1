function Disable-MerakiOrganizationIntegrationsXDRNetworks {
    ...
    Disable-MerakiOrganizationIntegrationsXDRNetworks -AuthToken 'your_api_key' -OrganizationID '123456' -XDRConfig $XDRConfig

    .NOTES
    - The function targets the Meraki endpoint to disable XDR integrations for networks in an organization.
    - Ensure the AuthToken has sufficient privileges to modify organization integrations.
    - The XDRConfig payload must conform to the Meraki API schema for the integrations/xdr/networks/disable endpoint.
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/organizations/$OrganizationId/integrations/xdr/networks/disable"
