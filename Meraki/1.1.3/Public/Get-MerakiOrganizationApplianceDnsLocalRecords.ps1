function Get-MerakiOrganizationApplianceDnsLocalRecords {
<#
.SYNOPSIS
Retrieves all Meraki Appliance DNS records for an organization.

.DESCRIPTION
Calls the Meraki Dashboard API to return DNS records associated with the specified organization.
...
Get-MerakiOrganizationApplianceDnsLocalRecords -AuthToken 'xxxxxxxxxxxxxxxxxxxx' -profileIds @('1', '2')
.LINK
...
#>    
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/appliance/dns/local/records?$queryString"
