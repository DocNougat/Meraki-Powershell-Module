function Get-MerakiOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDevice {
    <#
    .SYNOPSIS
    Retrieves the layer‑3 interface status change history for wireless controller devices in a Meraki organization, grouped by device.

    .DESCRIPTION
    Get-MerakiOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDevice calls the Meraki Dashboard API to return change history entries for L3 interface statuses for devices in a specified organization.
    ...
    When $true, include interfaces that have no recorded L3 status changes during the requested period.

    .EXAMPLE
    # Minimal: specify API key and organization
    Get-MerakiOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDevice -AuthToken 'abc123' -OrganizationID '123456'
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try { 
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/wirelessController/devices/interfaces/l3/statuses/changeHistory/byDevice?$queryString"
