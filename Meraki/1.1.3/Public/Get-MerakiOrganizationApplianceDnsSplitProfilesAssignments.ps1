function Get-MerakiOrganizationApplianceDnsSplitProfilesAssignments {
<#
.SYNOPSIS
Retrieves all Meraki Appliance DNS split profiles assignments for an organization.

.DESCRIPTION
Calls the Meraki Dashboard API to return DNS split profiles assignments associated with the specified organization.
...
Array. Optional. An array of network IDs to filter the DNS records.

.EXAMPLE

Get-MerakiOrganizationApplianceDnsSplitProfilesAssignments -AuthToken 'xxxxxxxxxxxxxxxxxxxx' -profileIds @('11234', '21432') -networkIDs @('N_1234', 'N_4321')
.LINK
...
#>    
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try {
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/appliance/dns/split/profiles/assignments?$queryString"
