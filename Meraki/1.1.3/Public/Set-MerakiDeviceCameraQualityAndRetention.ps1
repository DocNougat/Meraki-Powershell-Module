function Set-MerakiDeviceCameraQualityAndRetention {
    ...
    $QualityAndRetentionConfig = $QualityAndRetentionConfig | ConvertTo-Json -Compress -Depth 4
    ...
    #>
        ...
        try {
            ...
            $url = "https://api.meraki.com/api/v1/devices/$DeviceSerial/camera/qualityAndRetention"
