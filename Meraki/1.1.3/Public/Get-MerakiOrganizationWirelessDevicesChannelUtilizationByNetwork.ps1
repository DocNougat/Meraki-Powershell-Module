function Get-MerakiOrganizationWirelessDevicesChannelUtilizationByNetwork {
    <#
    .SYNOPSIS
    Retrieves wireless channel utilization by network for a Meraki organization.
    ...
    Get-MerakiOrganizationWirelessDevicesChannelUtilizationByNetwork -AuthToken 'myApiKey' -OrganizationID '123456'
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try { 
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/wireless/devices/channelUtilization/byNetwork?$queryString"
