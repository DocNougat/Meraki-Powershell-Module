function Set-MerakiNetworkCellularGatewayUplink {
    ...
    $UplinkConfig = $UplinkConfig | ConvertTo-Json -Compress -Depth 4
    ...
    #>
        ...
        try {
            ...
            $response = Invoke-RestMethod -Method Put -Uri $url -headers $header -UserAgent "MerakiPowerShellModule/1.1.3 DocNougat" -Body $UplinkConfig
            return $response
        }
        catch {
        Write-Debug $_
