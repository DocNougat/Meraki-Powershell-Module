function Get-MerakiOrganizationWirelessDevicesSystemCpuLoadHistory {
    <#
    .SYNOPSIS
    Retrieves the system CPU load history for wireless devices in a Meraki organization.

    .DESCRIPTION
    Get-MerakiOrganizationWirelessDevicesSystemCpuLoadHistory queries the Meraki Dashboard API
    endpoint /organizations/{organizationId}/wireless/devices/system/cpu/load/history and returns
    history records of device system CPU load changes. The function builds query parameters
    ...
    .EXAMPLE
    # Retrieve system CPU load history for an organization using a token and explicit Org ID
    Get-MerakiOrganizationWirelessDevicesSystemCpuLoadHistory -AuthToken $token -OrganizationID "123456"

    .NOTES
    - The function calls the Meraki API v1 endpoint:
        https://api.meraki.com/api/v1/organizations/{organizationId}/wireless/devices/system/cpu/load/history
