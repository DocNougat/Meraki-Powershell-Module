function Get-MerakiOrganizationWirelessControllerDevicesInterfacesL2ByDevice {
    <#
    .SYNOPSIS
    Retrieves Layer 2 interface information for wireless controller devices in a Meraki organization, grouped by device.

    .DESCRIPTION
    Calls the Meraki Dashboard API endpoint GET /organizations/{organizationId}/wirelessController/devices/interfaces/l2/byDevice and returns the parsed JSON response.
    ...
    .EXAMPLE
    PS> Get-MerakiOrganizationWirelessControllerDevicesInterfacesL2ByDevice -AuthToken $token -OrganizationID "123456" -timespan 3600

    Retrieves L2 interface data for organization 123456 for the last hour.
    ...
    If($OrganizationID -eq "Multiple organizations found. Please specify an organization ID.") {
        ...
        try { 
            ...
            $URL = "https://api.meraki.com/api/v1/organizations/$OrganizationID/wirelessController/devices/interfaces/l2/byDevice?$queryString"
