function Get-MerakiNetworkApplianceFirewallOneToManyNatRules {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/appliance/firewall/oneToManyNatRules" -Header $header -ErrorAction Stop
        return $response
    }
    catch {
