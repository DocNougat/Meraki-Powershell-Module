function Get-MerakiNetworkApplianceFirewallOneToOneNatRules {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/appliance/firewall/oneToOneNatRules" -Header $header -ErrorAction Stop
        return $response
    } catch {
