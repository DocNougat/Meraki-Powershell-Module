function Set-MerakiNetworkMqttBroker {
    ...
    This example updates the MQTT broker with ID "1234" for the Meraki network with ID "L_123456789012345678", setting the name to "MQTT_Broker_1", the host to "1.1.2.1", the port to 1234, and the security settings to use TLS with hostname verification enabled and optional authentication settings.
