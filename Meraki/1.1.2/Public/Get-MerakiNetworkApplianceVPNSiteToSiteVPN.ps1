function Get-MerakiNetworkApplianceVPNSiteToSiteVPN {
    ...
    try {
        ...
        $response = Invoke-RestMethod "https://api.meraki.com/api/v1/networks/$NetworkID/appliance/vpn/siteToSiteVpn" -Method 'GET' -Headers $header -UserAgent "MerakiPowerShellModule/1.1.2 DocNougat"
        return $response
    }
    catch {
        Write-Debug $_
