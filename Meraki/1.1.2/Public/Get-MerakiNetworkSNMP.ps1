function Get-MerakiNetworkSNMP {
    ...
    try {
        ...
        $response = Invoke-RestMethod -Method Get -Uri "https://api.meraki.com/api/v1/networks/$NetworkId/snmp" -headers $header -UserAgent "MerakiPowerShellModule/1.1.2 DocNougat"
