function New-MerakiNetworkMqttBroker {
    ...
    This example creates an MQTT broker for the Meraki network with ID "L_123456789012345678", setting the name to "MQTT_Broker_1", the host to "1.1.2.1", the port to 1234, and the security settings to use TLS with hostname verification enabled and optional authentication settings.
